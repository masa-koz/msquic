...
CXPLAT_TLS_SECRETS gTlsSecrets;
    ...
    )
{
    ...
    case QUIC_CONNECTION_EVENT_CONNECTED:
        ...
        //
        printf("[conn][%p] Connected\n", Connection);
        WriteSslKeyLogFile("C:\\Users\\MasahiroKozuka\\sslkeylog.txt", &gTlsSecrets);
    ...
    )
{
    ...
    if (QUIC_FAILED(Status = MsQuic->SetParam(Connection, QUIC_PARAM_LEVEL_CONNECTION, QUIC_PARAM_CONN_TLS_SECRETS, sizeof(gTlsSecrets), (uint8_t*)&gTlsSecrets)))
    {
